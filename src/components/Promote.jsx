  ...
  return (
    <div className="flex flex-col justify-center items-center mt-20">
      <div className="flex items-center ">
        <h3 className="text-4xl text-center px-5 lg:text-6xl">
          好評不斷！邀請您免費體驗
        </h3>
      </div>
